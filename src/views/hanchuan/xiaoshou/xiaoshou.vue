<template>
    <div >
        ...
        <el-table
                ...
                style="width: 100%"
        >
            <el-table-column align="center" prop="id" label="产品批次" width="150"></el-table-column>
            <el-table-column align="center" prop="title" label="销售地点" width="260"></el-table-column>
            <el-table-column align="center" prop="in" label="数量" width="200"></el-table-column>
            <el-table-column
