<template>
    <div >
        ...
        >
            ...
            <el-table-column align="center" prop="title" label="产品清单" width="260"></el-table-column>
            <el-table-column align="center" prop="in" label="入库记录" width="300"></el-table-column>
            <el-table-column
                    prop="img_src"
                    header-align="center"
                    align="center"
            ...
            <el-table-column align="center" prop="out" label="出库记录" width="300"></el-table-column>
