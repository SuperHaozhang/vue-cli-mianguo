...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCount(){
                this.$http.get("http://localhost:8888/membercount",{
                }).then(res=>{
            ...
            getUserList(pageIndex=1){
                console.log(pageIndex+"1111");
                this.page = pageIndex;
                this.getCount();
                this.loading  = true;
                this.$http.get("/activelistone",{
                    params: {
            ...
            detalUserInfo(user){
                ...
                this.$http.get("/acticeImginfo",{
                    ...
                    this.imageList =this.imageList.splice(0,1,this.$config.STATIC_URL+res.data.img_src);
