<template>
    <div >
        ...
        >
            ...
            <el-table-column align="center" prop="cid" label="公司序列号" width="200"></el-table-column>
            <el-table-column align="center" prop="address" label="地址" width="300"></el-table-column>
